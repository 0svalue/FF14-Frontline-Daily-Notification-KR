...
# ANSI 색상 코드 정의 (디스코드 ansi 코드용)
# \u001b[31m = 빨강, \u001b[32m = 초록, \u001b[33m = 노랑, \u001b[34m = 파랑, \u001b[35m = 핑크, \u001b[36m = 청록
# 각 멘트마다 알록달록하게 색상을 부여했습니다.
CUSTOM_MESSAGES = {
    "봉인된 바위섬(쟁탈전)": [
        "\u001b[31m🔥 \u001b[33m봉\u001b[32m바!\u001b[34m봉\u001b[35m바!\u001b[36m봉바! \u001b[31m🔥",
        "\u001b[36m🏝️ 오늘은 \u001b[33m봉바 타임! \u001b[32m거점 점령하러 \u001b[35m가자!",
        "\u001b[35m⚔️ 봉인된 바위섬 개장! \u001b[33m바위 치러 \u001b[32m갑시다!",
    ],
    "영광의 평원(쇄빙전)": [
        "\u001b[34m🧊 얼음 깰 시간이다! \u001b[36m쇄빙전 \u001b[33m출발!",
        "\u001b[36m❄️ 영광의 평원! \u001b[35m오늘 대형 얼음은 \u001b[32m우리 거!",
        "\u001b[33m⛏️ 쇄빙쇄빙! \u001b[31m얼음 쾅쾅 \u001b[34m깨러 가요!",
    ],
    "온살 하카이르(계절끝 합전)": [
        "\u001b[31m🐎 온살! \u001b[33m온살! \u001b[32m중앙 전투 \u001b[35m가자!",
        "\u001b[32m⛺ 온살 하카이르! \u001b[36m땅따먹기 \u001b[33m대작전!",
        "\u001b[33m🏹 오늘은 온살! \u001b[31m달려라 \u001b[35m달려!",
    ],
    "외곽 유적지대(제압전)": [
        "\u001b[35m🏛️ 추억의 제압전! \u001b[33m외곽 \u001b[32m유적지대!",
        "\u001b[31m💥 제압전이다! \u001b[36m기지 점령하고 \u001b[33m가실게요!",
        "\u001b[34m🛡️ 외곽 유적지대 오픈! \u001b[32m거점을 \u001b[35m지켜라!",
    ],
    "워코 치테(연습전)": [
        "\u001b[32m⚔️ 연습전 워코 치테! \u001b[33m가볍게 \u001b[35m즐겨볼까요?",
...
messages = CUSTOM_MESSAGES.get(
    today_frontline, [f"\u001b[33m{today_frontline}"]
)
today_custom_message = random.choice(messages)

# 6. 디스코드 전송 메시지 구성 (ansi 코드 블록 적용)
rotation_text = "\n".join(
    [
...
message_content = f"""⚔️ **[FF14] 오늘의 전장 안내 ({today_str} {weekday_str}요일)** ⚔️

오늘의 전장:
```ansi
{today_custom_message}
[ 8일 로테이션 표 ]
{rotation_text}
```"""
